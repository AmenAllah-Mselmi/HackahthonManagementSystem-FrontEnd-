...
export default function DemoPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:8080/api/attendee/all");
  ...
  const addAttendee = () => {
    router.push("/admin/attendees/create");
  };
      ...
      <div className="flex justify-between items-center container mx-auto w-5/6">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink href="/components">Attendee</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
              <Slash />
            </BreadcrumbSeparator>
