  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8080/api/attendee/create",
        payload
      );

      toast({
        title: "Registration successful",
        description: `Attendee ${response.data.Name} has been successfully registered.`,
      });
    ...
    <div className="w-screen h-screen flex justify-center flex-col items-center lg:w-[1200px]">
      ...
      >
        ...
        <div>
          ...
          <Select onValueChange={(value) => setDegree(value)} required>
        ...
        <div>
          ...
          <Select onValueChange={(value) => setYears(value)} required>
