...
import { Workshop, columns } from "./columns";
...
export default function DemoPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:8080/api/workshop/all");
      ...
      <div className="flex justify-between items-center container mx-auto w-5/6">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink href="/components">Workshops</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
              <Slash />
            </BreadcrumbSeparator>
        ...
        <Button onClick={() => router.push("/admin/workshops/create")}>Add Workshop</Button>
      </div>
